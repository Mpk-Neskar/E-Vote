...
<div class="col-md-6">
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title">Putri Anggreani Ibrahim</h5>
            <p class="card-text">Kandidat Ketua MPK Nomor 2 Periode 2023 / 2024</p>
...
<script>
  ...
  document.getElementById('showVisiMisi').addEventListener('click', function(event) {
    ...
    Swal.fire({
      ...
      html: '<strong>Visi:</strong><br>Menjadikan Organisasi MPK sebagai Organisasi Legislatif yang mampu menyerap aspirasi, membangun kolaborasi dan menjunjung Demokrasi.<br><br>' +

            '<strong>Misi:</strong><br>- Menjalin kolaborasi dan komunikasi yang baik dengan Organisasi lain, baik dalam hal acara sekolah seperti Pemilihan Ketua OSIS maupun dalam hal pengembangan Organisasi.<br> - Mengadakan forum rutin evaluasi Badan Pengurus Harian (BPH) dan anggota MPK dalam jangka waktu 1 bulan sekali.<br> - Membebaskan Anggota MPK saat mengemukakan pendapatnya. Baik dalam hal pengevaluasian maupun saat forum forum yang diadakan.',
      icon: 'info',
    ...
    <script>
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                xhr.open('POST', 'update_vote2.php'); // Ganti 'update_vote.php' dengan nama file PHP yang sesuai
